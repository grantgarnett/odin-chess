...
describe DetermineCheckAndMate do
  subject(:check_determination) { DetermineCheckAndMate.new(Board.new) }
      ...
      it "returns true" do
        ...
        check_determination.board.instance_variable_set(:@game_state,
                                                        [%w[x x x x x x x x],
                                                         ...
                                                         %w[x x x x x x x x]])
        expect(check_determination.in_check?("w")).to be true
      end
    end
      ...
      it "returns false" do
        ...
        check_determination.board.instance_variable_set(:@game_state,
                                                        [%w[x x x x x x x x],
                                                         ...
                                                         %w[x x x x x x x x]])
        expect(check_determination.in_check?("w")).to be false
      end
    end
      ...
      it "returns true" do
        ...
        check_determination.board.instance_variable_set(:@game_state,
                                                        [%w[x x x x x x x x],
                                                         ...
                                                         %w[x x x x x x x x]])
        expect(check_determination.in_check?("b")).to be true
      end
    end
      ...
      it "returns false" do
        ...
        check_determination.board.instance_variable_set(:@game_state,
                                                        [%w[x x x x x x x x],
                                                         ...
                                                         ["x", "x", "x", black_king, "x", "x", "x", "x"],
                                                         %w[x x x x x x x x]])
        expect(check_determination.in_check?("b")).to be false
      end
    end
  end
end
